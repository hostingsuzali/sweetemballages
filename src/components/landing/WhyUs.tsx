            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <FadeInRight>
                        ...
                        {/* Stats */}
                        <div className="grid grid-cols-3 gap-6 p-6 bg-background rounded-2xl border border-border">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        {reasons.map((reason, index) => (
                            <FadeIn
                                key={reason.title}
                                delay={index * 0.1}
                                className="bg-background rounded-xl p-6 border border-border hover:border-kraft transition-colors"
                            >
